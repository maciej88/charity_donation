document.addEventListener("DOMContentLoaded", function () {
    ...
    function show_organization(listCategories) {
        var address = '/get_institution_by_category/';
        var data2 = {'category_id': listCategories};


        $.ajax(address, {
            traditional: true, data: data2, success: function (data, status) {
                console.log(data);
    ...
    class FormSteps {
        ...
        updateForm() {
            if (this.currentStep == 3) {
                ...
                $('input[name="categories"]:checked').each(function () {
                    listCategories.push(this.value)
                })
                console.log(listCategories);
                show_organization(listCategories)
            }
        ...
        submit(e) {
            ...
            if(address.value == ' || address.value == null'){
                messages.push("Podaj nazwę ulicy")
            }
